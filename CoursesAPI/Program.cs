...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Course>(e =>
        {
            ...
            e.Property(p => p.StartAt).HasDefaultValueSql("getdate()");
            e.Property(p => p.Duration).HasDefaultValue(30);
            e.Property(p => p.StartAtInPersian).HasDefaultValueSql("FORMAT(getdate(),'yyyy-MM-dd HH:mm:ss','fa')");
